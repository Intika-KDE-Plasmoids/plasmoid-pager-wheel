...
MouseArea {
    ...
    property string currentVersion: '5.0';
    ...
    function availableUpdate() {
        var notificationCommand = "notify-send --icon=remmina-panel 'Plasmoid KDE Desktop Pager Wheel' 'An update is available \n<a href=\"https://www.opendesktop.org/p/1290177/\">Update link</a>' -t 30000";
        executableNotification.exec(notificationCommand);
    }

    function noAvailableUpdate() {
        var notificationCommand = "notify-send --icon=remmina-panel 'Plasmoid KDE Desktop Pager Wheel' 'Your current version is up to date' -t 30000";
        executableNotification.exec(notificationCommand);
    }
    ...
    function updaterNotification(notifyUpdated) {
        ...
        xhr.open("GET", "https://raw.githubusercontent.com/Intika-Linux-Plasmoid/plasmoid-pager-wheel/master/version");
